...
var s = (function () {
  ...
  s.getResource = function (profile) {
    ...
    var r = resources[s.language(profile)];
  ...
  s.redirectUrl = location.origin + '/index.html?redirect=oauth2';
    ...
    if (exact) {
      for (var _i = 0, ps_3 = ps; _i < ps_3.length; _i++) {
        ...
        if (path === privilege.path) {
          ...
          var ok = hasPrivilege(privilege.children, path, exact);
          if (ok) {
            return true;
          }
        }
...
exports.usePrivileges = privileges;
