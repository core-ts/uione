...
function alert(msg, callback, header, detail) {
  var h = (header == undefined ? s.errorHeader : header);
...
function confirm(msg, yesCallback, header, btnLeftText, btnRightText, noCallback) {
  var h = (header == undefined ? s.confirmHeader : header);
  var n = (btnLeftText == undefined ? s.no : btnLeftText);
  var y = (btnRightText == undefined ? s.yes : btnRightText);
