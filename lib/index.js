...
var storage = (function () {
  ...
  storage.setStatus = function (s, o) {
    storage._status = s;
  };
  storage.status = function (o) {
    return storage._status;
  };
  storage.setDiff = function (s, o) {
    storage._diff = s;
  };
  storage.diff = function (o) {
  ...
  storage.setLanguage = function (lang, o) {
    storage._lang = lang;
  };
  storage.setUser = function (usr, o) {
    storage._user = usr;
  ...
  storage.getUserId = function (o) {
    var u = storage.user(o);
    return (!u ? '' : u.id);
  };
  storage.username = function (o) {
    var u = storage.user(o);
    return (!u ? '' : u.username);
  };
  storage.token = function (o) {
    var u = storage.user(o);
    return (!u ? null : u.token);
  };
  storage.getUserType = function (o) {
    var u = storage.user(o);
    return (!u ? null : u.userType);
  };
  storage.getDateFormat = function (o) {
    var u = storage.user(o);
    var lang;
    if (u) {
      if (u.dateFormat) {
  ...
  storage.language = function (o) {
    ...
    if (u && u.language) {
      ...
      return getBrowserLanguage(o);
    }
  };
  storage.getLocale = function (o) {
    if (storage.locale) {
      var lang = storage.language(o);
  ...
  storage.getResources = function (o) {
    return storage._resources;
  };
  storage.setResources = function (resources, o) {
    storage._resources = resources;
  };
  storage.setResourceService = function (r, o) {
    storage._rs = r;
  };
  storage.resource = function (o) {
    return storage._rs;
  };
  storage.getResource = function (o) {
    var resources = storage._resources;
    var r = resources[storage.language(o)];
    return (r ? r : resources['en']);
  };
  storage.getResourceByLocale = function (id, o) {
  ...
  storage.setInitModel = function (init, o) {
    storage._initModel = init;
  };
  storage.getInitModel = function (o) {
    return storage._initModel;
  };
  storage.setConfig = function (c, o) {
    storage._c = c;
  };
  storage.config = function (o) {
    return storage._c;
  };
...
function status(o) {
  return storage.status(o);
}
exports.status = status;
function setStatus(s, o) {
  return storage.setStatus(s, o);
}
exports.setStatus = setStatus;
function diff(o) {
  return storage.diff(o);
}
exports.diff = diff;
function setDiff(s, o) {
  return storage.setDiff(s, o);
}
exports.setDiff = setDiff;
function setUser(usr, o) {
  storage.setUser(usr, o);
}
exports.setUser = setUser;
function setLanguage(lang, o) {
  storage.setLanguage(lang, o);
}
exports.setLanguage = setLanguage;
function language(o) {
  return storage.language(o);
}
exports.language = language;
function getDateFormat(o) {
  return storage.getDateFormat(o);
}
...
function user(o) {
  return storage.user(o);
}
exports.user = user;
function username(o) {
  return storage.username(o);
}
exports.username = username;
function getUserType(o) {
  return storage.getUserType(o);
}
exports.getUserType = getUserType;
function token(o) {
  return storage.token(o);
}
exports.token = token;
function getUserId(o) {
  return storage.getUserId(o);
}
...
function getLocale(o) {
  return storage.getLocale(o);
}
exports.getLocale = getLocale;
function getInitModel(o) {
  return storage.getInitModel(o);
}
exports.getInitModel = getInitModel;
function config(o) {
  return storage.config(o);
}
...
function inputSearch(o) {
  var i = {
    resource: storage.resource(o),
...
function inputEdit(o) {
  var i = {
    ...
    getLocale: storage.getLocale,
    loading: storage.loading(),
    status: storage.status(o),
  };
  return i;
}
exports.inputEdit = inputEdit;
function inputDiff(o) {
  var i = {
    resource: storage.resource(o),
    showMessage: storage.message,
    showError: storage.alert,
    loading: storage.loading(),
    status: storage.diff(o)
  };
  return i;
}
